...
namespace COMP003B.SP25.FinalProject.ZhangS.Controllers
{
    public class ServiceTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Cost,DurationEstimate,Notes")] ServiceType serviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Cost,DurationEstimate,Notes")] ServiceType serviceType)
        {
