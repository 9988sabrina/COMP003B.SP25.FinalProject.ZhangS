...
namespace COMP003B.SP25.FinalProject.ZhangS.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Specialization,PhoneNumber,CertificationNumber,ExperienceYears")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Specialization,PhoneNumber,CertificationNumber,ExperienceYears")] Mechanic mechanic)
        {
            if (id != mechanic.Id)
            {
                return NotFound();
